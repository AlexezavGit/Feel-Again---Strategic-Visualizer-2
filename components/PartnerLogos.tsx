...
export type LogoVariant = 'open_society' | 'geha' | 'usc' | 'solana' | 'highCastle' | 'feelAgain' | 'shevchenko';
...
const SolanaHighCastleLogo = () => (
  <svg viewBox="0 0 300 100" className="w-full h-full" fill="currentColor">
    ...
    <text x="175" y="45" fontFamily="sans-serif" fontSize="20" fontWeight="bold" fill="#9945FF">Solana</text>
  </svg>
);

const ShevchenkoLogo = () => (
  <svg viewBox="0 0 300 100" className="w-full h-full" fill="currentColor">
    {/* KNU stylized building/column */}
    <path d="M30 80 L30 20 L50 10 L70 20 L70 80 Z" fill="none" stroke="currentColor" strokeWidth="3" />
    <path d="M35 80 L35 25" stroke="currentColor" strokeWidth="2" />
    <path d="M45 80 L45 25" stroke="currentColor" strokeWidth="2" />
    <path d="M55 80 L55 25" stroke="currentColor" strokeWidth="2" />
    <path d="M65 80 L65 25" stroke="currentColor" strokeWidth="2" />
    
    {/* Text */}
    <text x="85" y="45" fontFamily="serif" fontSize="24" fontWeight="bold">KNU</text>
    <text x="85" y="70" fontFamily="sans-serif" fontSize="12" fontWeight="medium">SHEVCHENKO</text>
    <text x="140" y="45" fontFamily="sans-serif" fontSize="24" fontWeight="bold" fill="#b91c1c">1834</text>
  </svg>
);
...
export const PartnerLogo: React.FC<PartnerLogoProps> = ({ variant, className = "" }) => {
  ...
  switch (variant) {
    ...
    case 'solana':
      return <div className={containerClass} title="HighCastle / Solana"><SolanaHighCastleLogo /></div>;
    case 'shevchenko':
      return <div className={containerClass} title="Taras Shevchenko National University of Kyiv"><ShevchenkoLogo /></div>;
    default:
